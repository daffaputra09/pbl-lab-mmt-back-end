...
class GaleriController
{
    ...
    #[OA\Get(
        path: '/galeri',
        summary: 'List semua entri galeri dengan pagination',
        tags: ['Galeri'],
        parameters: [
            new OA\Parameter(
                name: 'page',
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: 'Daftar entri galeri dengan pagination',
                content: new OA\JsonContent(ref: '#/components/schemas/GaleriPaginatedResponse')
            ),
            new OA\Response(response: 400, description: 'Parameter tidak valid'),
            new OA\Response(response: 500, description: 'Gagal mengambil data galeri')
        ]
    )]
